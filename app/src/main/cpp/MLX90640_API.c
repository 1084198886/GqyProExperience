...
#define TAG "MLX-API" // 这个是自定义的LOG的标识
...
//            if(isnan(To) != 0){
//                if(pixelNumber > 0){
//                    To = result[pixelNumber-1];
//                }
//            }
            result[pixelNumber] = To;
            //LOGD("CalculateTo:%d,%d,%d,%.2f", pixelNumber,pattern,frameData[833], To);
        }
    }
    //LOGD("CalculateTo:%d,%d,%.2f", pattern,frameData[833], To);
}
